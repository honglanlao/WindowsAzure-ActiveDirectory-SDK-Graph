...
public class CommonService {
	 ...
	 */
	 public static <T extends DirectoryObjectList<? extends DirectoryObject>, S> T getDirectoryObjectList(Class<T> listType, Class<?> elementType, boolean paging, String skiptoken) throws SampleAppException{
		
		String paramString = null;
		if(paging == true){
			if(skiptoken == null){
				paramString = String.format("$top=%d", SampleConfig.getUserSizePerList());
			}else{
				paramString = String.format("$top=%d&$skiptoken=%s", SampleConfig.getUserSizePerList(), skiptoken);
			}
		}
		JSONObject response = restClient.GET(SampleConfig.getGraphAPI(elementType.getSimpleName()), paramString, null);
	 ...
	 * @throws SampleAppException 
	 */
	public static <S extends DirectoryObject> S getSingleDirectoryObject(Class<S> elementType, String objectId) throws SampleAppException{
				
		// Construct param
		String paramString = String.format("/%s", objectId);

		JSONObject response = restClient.GET(SampleConfig.getGraphAPI(elementType.getSimpleName()) + paramString, null, null);
	 ...
	 */
	public static JSONObject createDirectoryObject(HttpServletRequest request, String controller) throws SampleAppException{		
		...
		JSONObject response = restClient.POST(SampleConfig.getGraphAPI(controller), paramString, payLoad, "create" + controller, null);
		return response;
	}
	
	public static JSONObject deleteDirectoryObject(HttpServletRequest request, String controller) throws SampleAppException{		
		...
		JSONObject response = restClient.DELETE(SampleConfig.getGraphAPI(controller), paramString, payLoad, "delete" + controller, null);
		return response;
	}
	
	public static JSONObject updateDirectoryObject(String objectId, HttpServletRequest request, String controller) throws SampleAppException{		

		// construct 
		String payLoad = JSONHelper.createJSONString(request, controller);
		String paramString = String.format("/%s", objectId);		 
		
		JSONObject response = restClient.PATCH(SampleConfig.getGraphAPI(controller), paramString, payLoad, "update" + controller, null);
		return response;
	}
	 ...
	 */	
	public static JSONObject addDirectoryObjectToMemberOf(String directoryObjectObjectIds, String memberOfObjectId, String controller) throws SampleAppException {

		String directoryObject = String.format("%s://%s/%s/directoryObjects/%s", 
				SampleConfig.PROTOCOL_NAME, SampleConfig.getRestServiceHost(), SampleConfig.getTenantContextId(), directoryObjectObjectIds);
		...
		JSONObject response = restClient.POST(SampleConfig.getGraphAPI(controller), paramString, payLoad, "addUserToMemberOf", null);
		return response; 
	}
	 ...
	 * @throws SampleAppException
	 */
	public static JSONArray addDirectoryObjectsToMemberOf(String[] directoryObjectObjectIds, String memberOfObjectId , String controller) throws SampleAppException {
	...
	public static JSONArray addDirectoryObjectsToMemberOf( String directoryObjectObjectId, String[] memberOfObjectId, String controller) throws SampleAppException {
	 ...
	 * @throws SampleAppException If the operation can not be successfully carried out.
	 */	
	public static JSONObject removeDirectoryObjectFromMemberOf(String directoryObjectObjectId, String memberOfObjectId , String controller) throws SampleAppException {

		String paramString = String.format("/%s/$links/members/%s", memberOfObjectId, directoryObjectObjectId);
		String payLoad = "";
		JSONObject response = restClient.DELETE(SampleConfig.getGraphAPI(controller), paramString, payLoad, "removeUserFromMemberOf", null);
		return response; 
	}
	 ...
	 * @throws SampleAppException
	 */
	public static JSONArray removeDirectoryObjectsFromMemberOf(String[]  directoryObjectObjectIds, String memberOfObjectId , String controller) throws SampleAppException {
	...
	public static boolean isMemberOf( String objectId, String memberOfName) throws SampleAppException {
	 ...
	 * @return
	 */
	public static <T extends DirectoryObjectList<? extends DirectoryObject>, S> JSONObject getDifferentialDirectoryObjectList(Class<T> listType, Class<?> elementType, String deltaLink) throws SampleAppException{
		
		
		String paramStr = String.format("deltaLink=%s", deltaLink);
		
		JSONObject response = restClient.GET(SampleConfig.getGraphAPI(elementType.getSimpleName()), paramStr, null);
